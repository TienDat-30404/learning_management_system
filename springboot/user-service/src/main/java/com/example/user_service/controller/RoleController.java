...
import com.example.user_service.service.role.RoleService;
...
public class RoleController {
        ...
        public ResponseEntity<ApiResponseDTO<RoleResponseDTO>> updateRole(
                ...
                ApiResponseDTO<RoleResponseDTO> response = new ApiResponseDTO<>(
                                HttpStatus.OK.value(), roleResponseDTO, "Role updated successfully");
        ...
        public ResponseEntity<ApiResponseDTO<Void>> deleteRole(@PathVariable Long id) {
                ...
                ApiResponseDTO<Void> response = new ApiResponseDTO<>(
                                HttpStatus.OK.value(), null, "Role deleted successfully");
                return ResponseEntity.ok(response);
        }
}
