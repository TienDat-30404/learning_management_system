...
public class CategoryController {
    ...
    public ResponseEntity<ApiResponseDTO<CustomPageDTO<CategoryResponseDTO>>> getAllCategories(
        ...
        ApiResponseDTO<CustomPageDTO<CategoryResponseDTO>> response = new ApiResponseDTO<>(200, categories, "Categories retrieved successfully");
    ...
    public ResponseEntity<ApiResponseDTO<CategoryResponseDTO>> createCategory(
        ...
        ApiResponseDTO<CategoryResponseDTO> response = new ApiResponseDTO<>(HttpStatus.CREATED.value(), category, "Category created successfully");
